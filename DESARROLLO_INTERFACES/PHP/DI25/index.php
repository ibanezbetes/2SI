...
<html lang="es">
    ...
    <body>
        ...
        <!-- ====== MENÚ ESTÁTICO (hardcodeado en HTML) ====== -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavDropdown">
                        <ul class="navbar-nav">
                            ...
                            <!-- Dropdown: Mantenimiento de datos -->
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <!-- Cada enlace carga una vista por AJAX en #capaContenido -->
                                    ...
                                    <li><a class="dropdown-item" 
                                        onclick="obtenerVista('Productos','getVistaProductosPrincipal','capaContenido');">Productos</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
